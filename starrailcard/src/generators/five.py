...
class Creat:
    ...
    async def creat_charters(self):
        if self.img:
            ...
            bg = await pill.creat_bg_teample_two(
                self.character.portrait, bg, maska=_of.mask_bg_five.convert("L"), teample=5
            )
    ...
    async def creat_lk(self):
        ...
        names = await pill.create_image_with_text(
            self.character.light_cone.name, 13, max_width=219, color=(255, 255, 255, 255)
        )
    ...
    async def main_skills(self):
        ...
        position_x = [(0, 0), (46, 0), (0, 24), (46, 24), (92, 0)]
    ...
    async def creat_name_banner(self):
        ...
        icon_element = await pill.get_dowload_img(
            self.character.element.icon, thumbnail_size=(22, 22)
        )
